...
public class CardEmulationFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        try {
            account.setText(new String(CardService.decrypt(AccountStorage.GetAccount(getActivity()))));
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private class AccountUpdater implements TextWatcher {
        ...
        public void afterTextChanged(Editable s) {
            ...
            try {
                byte[] acc = CardService.encrypt(account.getBytes());
                AccountStorage.SetAccount(getActivity(), acc);
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
